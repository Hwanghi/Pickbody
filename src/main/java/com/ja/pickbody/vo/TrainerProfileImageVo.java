...
public class TrainerProfileImageVo {
	private int image_no;
	private int trainer_no;
	private String image_link;
	private String image_original_filename;
	public TrainerProfileImageVo() {
		super();
	}
	public TrainerProfileImageVo(int image_no, int trainer_no, String image_link, String image_original_filename) {
		super();
