	...
	<div style="width: 1200px; margin: 0 auto;">
		...
		<div class="row">
					...
					<div class="col">
							...
							<form action="./updateBodygoodContentProcess.do" method="post">
							<!-- 글수정 제목 -->
							<div class="row mt-5">
								<div class="col d-grid">
									<input type="text" name="bodygood_title" value="${data.bodygoodVo.bodygood_title }" placeholder="제목을 수정해주세요.">
								</div>
							</div>
							...
							<div class="form-floating">								
								<textarea class="form-control" name="bodygood_content" style="height: 300px">${data.bodygoodVo.bodygood_content }</textarea>
								<label for="floatingTextarea2">내용을 입력하세요.</label>
								<input type="hidden" name="bodygood_no" value="${data.bodygoodVo.bodygood_no }">
