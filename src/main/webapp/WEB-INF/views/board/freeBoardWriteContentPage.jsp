...
<div style="width: 1200px; margin: 0 auto;">
		...
		<div class="container">
				...
				<form action="./freeBoardWriteContentProcess.do" method="post" enctype="multipart/form-data">
					<div class="row">
					<div class="col-3"></div>
					<div class="col">
					<div class="input-group mb-3">
					<span class="input-group-text" id="basic-addon1">제목</span>
					<input type="text" name="free_title" class="form-control" placeholder="제목을 입력해주세요." aria-label="Username" aria-describedby="basic-addon1">
					</div>
					 
					 <div class="form-floating d-grid my-3" ">
					  <textarea class="form-control" name="free_content" placeholder="내용을 작성해주세요." id="floatingTextarea" style="height: 500px"></textarea>
