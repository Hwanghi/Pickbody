							...
							<table class="table text-center">
							  <thead>
							    <tr>
							      ...
							      <th scope="col-2">받는사람</th>
							      <th scope="col-4">제목</th>
							      <th scope="col-4">보낸날짜</th>
							      <th scope="col-1"></th>
							    </tr>
							  </thead>
							  <tbody>
							  	<c:forEach var="list" items="${list }">
								    <tr>
								      ...
								      <td><a href="../member/sendMessageDetailPage.do?message_no=${list.vo.message_no}">
											${list.vo.message_title }</a></td>
								      <td><fmt:formatDate value="${list.vo.message_sendDate }" pattern="yy년 MM월 dd일 hh:mm" /></td>
								      <td>
								      	<a href="../member/updateSendMessageIsDeleted.do?message_no=${list.vo.message_no}">
