		...
		<div class="container">
			<div class="row mt-3 mb-5">
				...
				<div class="col-6">
					...
					<div class="row mt-2">
						<div class="col">
						<i class="bi bi-person-circle pe-2"></i>보낸사람 : <a href="../member/answerMessagePage.do?receive_no=${map.mVo.recieve_no}"> ${map.vo.member_nick } </a>
						</div>
					</div>
					<div class="row mt-2">
						<div class="col">
					...
					<div class="row mt-2">
						<div class="col-6 d-grid ps-0">
							<input type="button" class="btn" style="background-color:#F2CB05" value="답장" onClick="location.href='../member/answerMessagePage.do?receive_no=${map.mVo.sender_no}'">				
						</div>
						<div class="col-6 d-grid pe-0">
							<input type="button" class="btn btn-light" value="삭제" onClick="location.href='../member/updateReceiveMessageIsDeleted.do?message_no=${map.mVo.message_no}'">
						</div>
					</div>
				</div>
				<div class="col-3"></div>
